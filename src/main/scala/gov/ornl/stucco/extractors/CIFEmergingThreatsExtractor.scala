...
/**
 * CIF emergingthreats data extractor.
 *
 * see https://github.com/csirtgadgets/massive-octo-spice/blob/develop/src/rules/default/emergingthreats.yml
 *
 * @author Mike Iannacone
 */
object CIFEmergingThreatsExtractor extends Extractor {
