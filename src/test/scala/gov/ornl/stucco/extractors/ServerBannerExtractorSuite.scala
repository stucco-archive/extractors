...
"""
    ...
    assert(serverBanners ~> "vertices" ~> 0 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "vertices" ~> 1 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "vertices" ~> 2 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "vertices" ~> 3 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 0 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 1 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 2 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 3 ~> "source" === Some(S("server_banner")))
...
"""
    ...
    assert(serverBanners ~> "vertices" ~> 4 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "vertices" ~> 5 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "vertices" ~> 6 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "vertices" ~> 7 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "vertices" ~> 8 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "vertices" ~> 9 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "vertices" ~> 10 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "vertices" ~> 11 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 4 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 5 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 6 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 7 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 8 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 9 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 10 ~> "source" === Some(S("server_banner")))
    ...
    assert(serverBanners ~> "edges" ~> 11 ~> "source" === Some(S("server_banner")))
