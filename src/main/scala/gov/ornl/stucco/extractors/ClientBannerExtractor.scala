...
/**
 * client banner data extractor.
 *
 * @author Mike Iannacone
 */
object ClientBannerExtractor extends Extractor {
  ...
  def extract(node: ValueNode): ValueNode = {
    ...
    val headers = *("filename","recnum","file_type","amp_version","site","banner","addr","app_protocol","times_seen","first_seen_timet","last_seen_timet","countrycode","organization","lat","long")
